...
│   └── ...
├── {another-feature}/
│   └── {feature-name}.md    # Single-file plan is also acceptable
└── ...
```

### Storage Rules

1. **Directory name**: Use kebab-case describing the feature (e.g., `apple-login`, `group-api`, `admin-rest-api`)
...
`.claude/agents/planner.md` (project-level)
