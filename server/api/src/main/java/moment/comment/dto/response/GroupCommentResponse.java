...
public record GroupCommentResponse(
        ...
        @Schema(description = "이미지 최적화 URL", example = "https://example.com/images/sample.webp")
    ...
    public static GroupCommentResponse from(Comment comment, long likeCount, boolean hasLiked, String originalImageUrl,
                                            String optimizedImageUrl) {
        return new GroupCommentResponse(
                comment.getId(),
                comment.getContent(),
