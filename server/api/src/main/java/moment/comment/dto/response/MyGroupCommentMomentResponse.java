...
public record MyGroupCommentMomentResponse(
        ...
        @Schema(description = "Moment 이미지 원본 url", example = "https://example.com/image.jpg")
        String originalImageUrl,

        @Schema(description = "Moment 이미지 최적화 url", example = "https://example.com/image.webp")
    ...
    public static MyGroupCommentMomentResponse from(
        ...
        return new MyGroupCommentMomentResponse(
                ...
                momentComposition.optimizedUrl(),
